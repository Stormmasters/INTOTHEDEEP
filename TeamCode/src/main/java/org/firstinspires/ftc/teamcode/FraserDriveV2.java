...
public class FraserDriveV2 extends OpMode{
    ...
    public void init(){
        ...
        SV1 = hardwareMap.servo.get("hand_servo");
        ...
        SV1.setDirection(Servo.Direction.FORWARD);
    }
    @Override
    public void loop(){
        ...
        S1.setPower((gamepad1.left_trigger - gamepad1.right_trigger) * 0.5);
        S2.setPower((gamepad1.left_trigger - gamepad1.right_trigger) * 0.5);
        if (gamepad1.left_bumper){
            SV1.setPosition(SV1.getPosition() + 0.01);
        }
